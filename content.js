  ...
  categories: [
    {
      ...
      facts: [
        {
          title: 'Prepare a campaign crop for multiple channels',
          lede: 'Adjust framing and aspect ratios while preserving the visual focus.',
        ...
        },
        {
          ...
          lede: 'Create an edited variant and compare it with the original asset.',
        ...
        },
        {
          ...
          lede: 'Track edits, collect feedback, and record the final approval decision.',
